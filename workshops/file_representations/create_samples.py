...
def create_samples(client: Client):
    ...
    comments_folder = create_box_folder(client, "file_representations", wks_folder)
    folder_upload(client, comments_folder, "workshops/file_representations/content_samples/")
